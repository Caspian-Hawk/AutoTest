...
public class FirefoxTestButtonOrderUp { // флоу верхней кнопки "Заказать"
    ...
    public FirefoxTestButtonOrderUp(String name, String surname, String address, String telephone) {
        this.name = name;
